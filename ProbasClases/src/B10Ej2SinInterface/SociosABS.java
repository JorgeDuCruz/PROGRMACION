...
public class SociosABS extends MembroAsociacionABS {
    ...
    public SociosABS(String dni, String nome, double cuota, Data dataAlta, String direccion, String provincia) {
        super(dni, nome);
        setCuota(cuota);
